...
const ArrayLevelStru = Object.keys(levelStru);
...
npRoute.get(`/location/:id`, async (c) => {
...
npRoute.get("/search/:type/:parentId", async (c) => {
  ...
  const { data, error } = await supabase.rpc(
    "search_admin_divisions_with_parentid",
    {
      search: q,
      lvl: level,
      cid,
